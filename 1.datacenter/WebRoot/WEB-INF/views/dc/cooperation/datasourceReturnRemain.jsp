...
<div class="taskCreatBox">
            ...
            <table id="table01" cellpadding="0" cellspacing="15" class="taskCreate" width="100%">   
	            ...
	            <tr>
	               ...
	               <td align="left"><textarea id="handelOpinion" name="handelOpinion" cols="" rows="" class="textArea01" style="width:480px;height:150px;"></textarea></td>
	            </tr>
            	<tr>
	               <th width="20%"><em>*</em>提醒方式：</th>
	               <td>
		               <span><input type="checkbox" onclick="return false;" checked="checked" name="checkboxOA" value="0">OA待办</span>
		               <span><input type="checkbox" name="checkboxSMS" value="1">短信</span>
	               </td>
	            </tr>
	            <tr>
...
function checkSubmit(){
	...
	if( jQuery.trim(jQuery("#handelOpinion").val())=="" ){
		animateAlert("table01","handelOpinion", "审核意见不能为空" );
		return false;
	}
	if( $("#handelOpinion").val().length > 200 ){
		animateAlert("table01","handelOpinion","审核意见不得超过200个字" );
		return false;
	}
	return true;
}
...
function ev_submit(){
	...
	$("#form1").ajaxSubmit({
       	url:"<%=basePath%>copperationController/returnRemain",
    	dataType:'json',
        async:true,
        type:'POST',
