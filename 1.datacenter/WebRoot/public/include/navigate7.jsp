<%@page import="com.cdc.worksheetManage.worksheetManageFlow.bo.WorksheetOpertypeListBo"%>
<%@ page language="java" pageEncoding="UTF-8"%>
<%@page import="com.trustel.common.ItemPage"%>
<%@page import="org.trustel.system.SystemConstant"%>
<%
	//CHENJUFU MODIFY 20140107
	WorksheetOpertypeListBo bo = (WorksheetOpertypeListBo)request.getAttribute("bo");
	ItemPage itempage = bo.getItemPage();
