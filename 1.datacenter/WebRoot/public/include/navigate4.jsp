...
<div class="pageBox" style="width:600px; padding-bottom:0; padding-top:5px;">
	...
	<% for (int i = listbegin; i <= listend; i++) {
		...
		<span class="pageBox_font">
		    <a href="javascript:void(0);" onclick="javascript:gotoPage('-5');"<%if (pagesize == 5){ %>class="current2"<%} %> >5</a>
			...
			<a href="javascript:void(0);" onclick="javascript:gotoPage('-50');" <%if (pagesize == 50){ %>class="current2"<%} %>>50</a></span>
		<span style="float:right;">页</span>
	</div>
</div>
