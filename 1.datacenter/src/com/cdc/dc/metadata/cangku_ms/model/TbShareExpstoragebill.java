...
public class TbShareExpstoragebill implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareExpstoragebill() {
	}

	/** minimal constructor */
	public TbShareExpstoragebill(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareExpstoragebill(Integer billitype, Date createtime,
