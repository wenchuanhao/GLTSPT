...
public class TbShareCheckbill implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareCheckbill() {
	}

	/** minimal constructor */
	public TbShareCheckbill(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareCheckbill(Integer billitype, Date createtime,
