...
<div class="jf_super_wrap">
  ...
  <div class="col-2 row-1">
    <div class="chart_wrap">
        <h3 class="chart_title">${year}年南区天然气用量统计表</h3>
  ...
  <div class="col-2 row-1">
    <div class="chart_wrap">
        <h3 class="chart_title">${year}年南区天然气用量比例图</h3>
        <span class="switch02 switch_list"><i>数据</i></span>
...
<script type="text/javascript">
 ...
 //提交查询
function ev_search(){
	document.forms[0].action="<%=basePath%>/divsionGas/home";
	document.forms[0].submit();
}

$(function(){

	initContainerForTimeColumn('spline','#container01','用气量','立方米','container01',month,year);
