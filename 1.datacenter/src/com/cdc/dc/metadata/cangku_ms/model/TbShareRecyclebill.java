...
public class TbShareRecyclebill implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareRecyclebill() {
	}

	/** minimal constructor */
	public TbShareRecyclebill(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareRecyclebill(Integer billitype, Date createtime,
