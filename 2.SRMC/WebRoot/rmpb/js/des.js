...
*/
function strDesEnc(data, firstKey, secondKey, thirdKey) {
    var firstKey = "7eF5REzs";
    var secondKey = "suc6WU5a";
    var thirdKey = "ETIAyMHU";
...
*/
function strDesDec(data, firstKey, secondKey, thirdKey) {
    var firstKey = "7eF5REzs";
    var secondKey = "suc6WU5a";
    var thirdKey = "ETIAyMHU";
    var leng = data.length;
