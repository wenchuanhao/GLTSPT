...
<div class="gl_import_m">
	<div class="searchCondition">
		...
		<c:if test="${vo.id ne null}">
		<span class="searchCondition_header">修改-投资编码</span>
		</c:if>
	</div>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" class="editTable reeditTable" align="center" id="table01">
	    ...
	    <tr>
		    ...
		    <td><input name="column13"  id="column13"  type="text" class="text01" style="width:300px;" placeholder="请填写投资项目联系人"  onfocus="autoCompletes(this);" onblur="this.value=''"/>
	    ...
	    <tr>
		    ...
		    <td><input name="column14"  id="column14"  type="text" class="text01" style="width:300px;" placeholder="请填写投资项目督办人"   onfocus="autoCompletes(this);" onblur="this.value=''"/>
		    ...
		    <td><input name="column19"  id="column19"  type="text" class="text01" style="width:200px;" placeholder="请填写投资编码管理员"   onfocus="autoCompletes(this);" onblur="this.value=''"/>
...
function ev_save(){
	if(ev_required_item()){
		$("#form1").attr("action","<%=basePath%>tzbm/saveOrUpdate");
		$("#form1").submit();
	}
}
