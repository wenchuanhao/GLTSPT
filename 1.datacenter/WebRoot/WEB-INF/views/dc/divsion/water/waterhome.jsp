...
<div class="jf_super_wrap">
  ...
  <div class="col-2 row-1">
    <div class="chart_wrap">
        <h3 class="chart_title">${year}年南方基地用水统计图</h3>
        <span class="switch02 switch_list"><i>数据</i></span>
        <div class="chart_col02" id="containerWater01"></div>
        <div style="display: none;" class="list_wrap02 scroll">
            ...
            <table class="listTable" id="tbodycontainerWater01">
            </table>
        </div>
    </div>
  </div>
  <div class="col-2 row-1">
    <div class="chart_wrap">
        <h3 class="chart_title">${year}年南方基地用水比例图</h3>
        <span class="switch02 switch_list"><i>数据</i></span>
        <div class="chart_col02" id="containerWater02"></div>
        <div style="display: none;" class="list_wrap02 scroll">
        	<a href="javascript:void(0);" onclick="export_table(this)" class="export_chart">导出</a>
            <table class="listTable" id="tbodycontainerWater02">
            </table>
        </div>
    </div>
  </div> 
...
<script type="text/javascript">
 ...
 //提交查询
function ev_search(){
	document.forms[0].action="<%=basePath%>/divsion/water";
	document.forms[0].submit();
}

$(function(){

	initContainerForTimeColumn('spline','#containerWater01','用水量(m³)','m³','containerWater01',month,year);
	
	initContainerForPie('#containerWater02','containerWater02',month,year);
	//数据与列表切换
