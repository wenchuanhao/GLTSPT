       ...
       <form action="<%=basePath%>core/modifyPwd" name="form" id="form" >
        ...
        <div class="ydgl_cont01">
          <div class="ydgl_infor">
            <div class="ydgl_inforline" style="height:28px; line-height:28px;"> <span class="ydgl_icon05" style="margin-top:2px;margin-left: 40px;"></span>
              <h4>旧密码：</h4>
              <div class="ydgl_txtbox">
                <input type="password" class="ydgl_txt" name="oldPwd" id="oldPwd"  onchange="tocheckOldPwd()"/><img src="/SRMC/rmpb/images/OK.png" id="oldPwdOK" width="16" height="15" style="display:none;"/>
              </div>
              <div class="clear"></div>
            </div>

            <div id="oldPwdError" class="ydgl_inforline" style="height:26px; line-height:26px; padding-top:0px;display:none;">
                    <p class="ydgl_red" style="padding-left:180px;">旧密码输入错误，请重新输入!</p>
                    <div class="clear"></div>
                </div>
            ...
            <div class="ydgl_inforline" style="height:28px; line-height:28px;"> <span class="ydgl_icon05" style="margin-top:2px;margin-left: 40px;"></span>
              <h4>新密码：</h4>
              <div class="ydgl_txtbox">
                <input type="password" class="ydgl_txt" name="newPwd" id="newPwd" onchange="tocheckNewPwd()" /><img id="newPwdOK" src="/SRMC/rmpb/images/OK.png"  width="16" height="15" style="display:none;"  />
              </div>
              <div class="clear"></div>
            </div>
             <div id="newPwdError" class="ydgl_inforline" style="height:26px; line-height:26px; padding-top:0px;display:none;">
                	
                    <p class="ydgl_red" style="padding-left:180px;">密码必须满足至少包括字母和数字的6-24位字符！</p>
                    <div class="clear"></div>
                </div>
            <div class="ydgl_inforline" id="tips" style="height:26px; line-height:26px; padding-top:0px;display:none;">
                	<span class="ydgl_iconwarn" style="margin-top:1px; margin-left:180px;"></span>
                    <p class="ydgl_gray"  style="font-size: 12px;">请输入6-24位字符，至少包括字母和数字，特殊符号可选</p>
                    <div class="clear"></div>
                </div>
            
            <div class="ydgl_inforline" style="height:28px; line-height:28px; padding-top:20px;"> <span class="ydgl_icon06" style="margin-top:2px;margin-left: 40px;"></span>
              <h4> 确认新密码：</h4>
              <div class="ydgl_txtbox">
                <input type="password" class="ydgl_txt" name="newPwd1" id="newPwd1" onchange="toConfirmPwd()" /><img src="/SRMC/rmpb/images/OK.png" id="newPwd1OK" width="16" height="15" style="display:none;"/>
              </div>
              <div class="clear"></div>
            </div>

             <div id="different" class="ydgl_inforline" style="height:24px; line-height:20px; padding-top:0px;display:none;">
                	
                    <p class="ydgl_red" style="padding-left:180px;">您两次密码不一致，请重新输入！</p>
                    <div class="clear"></div>
                </div>

          </div>
          
          <div class="ydgl_mtit" style="margin-top:20px;">
          <h3>请输入预留系统中的手机号码以验证身份.</h3>
        </div>
           <div class="ydgl_infor">
