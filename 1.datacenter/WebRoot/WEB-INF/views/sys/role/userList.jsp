...
<script type="text/javascript">
	...
	function configUser(userId,optionId){
		...
		var url ="<%=basePath%>sys/role/saveConfigUser";
		var params = {
			"userId":userId,
		...
		jQuery.post(url, params, function(data){
				if(data=="0"){
					...
					//用户,配置
					window.parent.document.getElementById("toGetUser").src="<%=basePath%>sys/role/userList?flowNodeId="+flowNodeId + "&flowCode=${flowCode}&account="+account+"&userName="+userName+"&organizationId="+organizationId + "&pageSize=" +pageSize+"&pageIndex="+ pageIndex;
					window.parent.document.getElementById("userFlowActor").src="<%=basePath%>sys/role/getAllConfigUser?flowNodeId="+flowNodeId + "&flowCode=${flowCode}";
				}
		});
	} 
