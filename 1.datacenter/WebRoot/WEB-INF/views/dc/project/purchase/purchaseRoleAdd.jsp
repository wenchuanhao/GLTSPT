...
<div class="gl_import_m">
	...
	<form name="form" id="pagePurchaseForm" method="post"  >
     ...
     <tr>
	    ...
	    <td width="30%">
	    	<input id="roleName"   maxlength="100" name="roleName"  maxlength="30" type="text" class="text01" style="width:200px;"  />  	 
		</td> 
	 ...
	 <tr>
	    ...
	    <td width="30%">
	    <!-- <input type="hidden" name="userId" id="accountingId_input" value="${PurchaseForm.userId}"/>  --> 	    	    
         <input   onfocus="autoCompletes(this);"  onkeyup="clean(this)" type="text" name="manageName" id="sel_09" style="width:200px;" value="${PurchaseForm.manageName }" class="text01" />
	...
	<tr>
	 ...
	 <tr>
               ...
               <input id="save" name="" type="button" onclick="ev_save()" class="btn_common02" value="保 存" />  <input name="" type="button" onclick="back()" class="btn_common01" value="取 消" /></td>	   		</th>
	   </tr>  
	</table>
	</form>
</div>
...
$.ajax({
		url:"<%=basePath%>purchase/submitPurchaseRole",
    	dataType:'json',
        async:true,
        type:'POST',
...
//document.forms[0].action="<%=basePath%>purchase/submitPurchaseRole";
