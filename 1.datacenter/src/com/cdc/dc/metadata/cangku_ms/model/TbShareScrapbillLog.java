...
public class TbShareScrapbillLog implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareScrapbillLog() {
	}

	/** minimal constructor */
	public TbShareScrapbillLog(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareScrapbillLog(Integer billitype, Date createtime,
