			...
			<tr>
				<td valign="top" style="display: block;">
					...
					<form name="form" id="form" method="post"
						action="<%=basePath%>/sys/user/upUser">
						<!-- 
               <table class="gl_table_a01_b" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                 ...
                 <tr>
                   ...
                   <td colspan="3">
                   		<input type="hidden" name="organizationId" value="${user.organizationId}" id="organizationId"/>
							...
							<tr>
								...
								<td colspan="5">
									<input type="hidden" name="organizationId"
										value="${user.organizationId}" id="organizationId" />
									<input type="hidden" name="userId"
										value="${user.userId}" id="userId" />
