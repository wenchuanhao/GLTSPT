...
public class TbShareDepartmentall implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareDepartmentall() {
	}

	/** minimal constructor */
	public TbShareDepartmentall(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareDepartmentall(Integer billitype, Date createtime,
