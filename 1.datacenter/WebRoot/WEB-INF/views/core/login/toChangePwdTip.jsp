...
<!--弹窗部分 start-->
<div class="postup_box">
  <p>${force_message}</p>
  <div class="steps_borderb"> <a href="<%=basePath%>core/toConfirm"><img src="/SRMC/rmpb/images/sure_btn.jpg" /></a> </div>
</div>
<!--弹窗部分 end-->
      ...
      <div class="ydgl_main">
		...
		<div class="borderOut" >
          ...
          <div class="ydgl_btnline">
            <input type="button" class=" ydgl_btnnext" value="" />
            <input type="button" class=" ydgl_btnback" value="" />
          </div>
        </div>
