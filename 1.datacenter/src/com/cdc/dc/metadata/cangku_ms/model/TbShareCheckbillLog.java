...
public class TbShareCheckbillLog implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareCheckbillLog() {
	}

	/** minimal constructor */
	public TbShareCheckbillLog(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareCheckbillLog(Integer billitype, Date createtime,
			String checkbillcode, Integer catagoryid, String catagoryname,
			String materialsid, String materialscode, String materialsname,
			Double price, Double qty, Double amount, Integer departmentid,
