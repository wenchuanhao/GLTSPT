...
<div class="contract_wraper">
	<div class="contract" id="contract" style="height:auto;">
		<div class="contract_head">
			<h1 class="contract_title">A2类工作指令<i>（施工单位提出的变更）</i></h1>
		...
		<table class="contract_table">
			...
			<tr>
				<td colspan="2" class="noBorderR">变更资料附件:</td>
			...
			<tr class="noBorder">
				<td colspan="12">
                <div class="pad-btm10">监理公司意见：</div> 
                </td>
		  </tr>
			<tr>
				<td colspan="12">
			...
			<tr>
				<td colspan="6" class="noBorderR" >
					<div class="contract_area_wrap" style="text-align: left;">
						<textarea class="contract_area1" style="overflow: hidden;"></textarea>
						<span class="contract_txt2">
							<i>专业工程师签名：</i>
							<input type="text" />
						</span>
