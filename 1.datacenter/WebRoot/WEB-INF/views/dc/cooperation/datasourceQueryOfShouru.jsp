...
<div class="gl_import_m">
    ...
    <input type="hidden" value="${cooperationForm.userid}" id="userid_input"	name="userid"/>	
  	...
  	<div class="tabpages">
    	<ul class="l">
      		<li onclick="" class="current">主题维度</li>
    	</ul>
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listTable">
	  ...
	  <c:forEach items="${ITEMPAGE_ZT.items}" var="item" varStatus="i">
	...
	<div class="tabpages">
    	<ul class="l">
      		<li onclick="" class="current">费用维度</li>
    	</ul>
  	</div>
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listTable">
	  <tr>
	  ...
	  <c:forEach items="${ITEMPAGE_FY.items}" var="item" varStatus="i">
	  	 <tr <c:if test="${i.count % 2 == 1}">class="td01"</c:if>>
	  	 	<td ><input name="subBox" type="checkbox"></td>
	  	  	<td >${i.count}</td>
	  	  	<c:forEach items="${interfaceTableName}" var="iTable"  varStatus="j">
