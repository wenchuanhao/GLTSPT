...
; + function($) {
    ...
    UI_select.prototype = {
        ...
        _setHtml: function() {
            ...
            this.el.find('option').each(function(index, el) {
                var _this = $(el),
                    ...
                    _title = _this.prop('title'),
                    _selected = _this.prop('selected') ? 'selected' : '',
                    _disabled = _this.prop('disabled') ? ' disabled' : '';
                _ohtml += '<li title="' + _title + '" data-value="' + _value + '" class="' + _selected + _disabled + '">' + _text + '</li> ';
            });
            ...
            var _title = this._list.children('li.selected').prop('title');
            this._input.text(_txt).attr('title', _title);
        },
        ...
        val: function(value) {
            ...
            this._input.html(_selectedLi.text()).attr('title', _selectedLi.prop('title'));
            if (_val != value) {
