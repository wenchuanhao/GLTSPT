...
public class TbShareExpstoragebillLog implements java.io.Serializable {
	...
	/** default constructor */
	public TbShareExpstoragebillLog() {
	}

	/** minimal constructor */
	public TbShareExpstoragebillLog(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareExpstoragebillLog(Integer billitype, Date createtime,
			String expbillcode, Integer catagoryid, String catagoryname,
	...
	public void setExpbillcode(String expbillcode) {
		this.expbillcode = expbillcode;
	}
