package com.cdc.dc.command.zlb.controller;
...
public class ZlbController extends CommonController{

	@Autowired
	private ICommandService commandService;
	@Autowired
	private IZlbService zlbService;
	/**
     * 新增一个表单
     */
    @RequestMapping(value = "zlbAdd", method = {RequestMethod.GET,RequestMethod.POST})
...
String id = request.getParameter("id");
     ...
     * 详情
     */
    @RequestMapping(value = "zlbAddQuery", method = {RequestMethod.GET,RequestMethod.POST})
    public String zlbAddQuery(HttpServletRequest request,HttpServletResponse response) throws Exception{
    	String id = request.getParameter("id");
    	CommandWorks cw = null;
    	if (id != null && !id.equals("")) {
    		cw = (CommandWorks) commandService.getEntity(CommandWorks.class, id);
    	...
    	return "/dc/command/zlb/zlbQuery";
    }
    /**
     * 保存或者修改
     */
    @RequestMapping(value = "zlbSaveOrUpdate", method = {RequestMethod.GET,RequestMethod.POST})
    @ResponseBody
    public void zlbSaveOrUpdate(HttpServletRequest request, HttpServletResponse response,CommandWorks cw){
    	//保存失败
    	String result = "0";
    	try{
     ...
     * 打印
     */
    @RequestMapping(value = "zlbAddView", method = {RequestMethod.GET,RequestMethod.POST})
    public String zlbAddView(HttpServletRequest request,HttpServletResponse response) throws Exception{
    	String id = request.getParameter("id");
    	CommandWorks cw = null;
    	if (id != null && !id.equals("")) {
    		cw = (CommandWorks) commandService.getEntity(CommandWorks.class, id);
