...
<script type="text/javascript">
	...
	window.parent.document.getElementById("sysId").value=brandsId;
	window.parent.document.getElementById("sysName").value=brandEName;
...
<body class="bg_c_g" >
	<div class="gl_m_r_nav">当前位置 : 系统管理 &gt;应用系统管理&gt; 数据获取管理</div>
	<div class="zy_a01"  style="width:94%; margin:0 auto 10px auto; padding:3px 0 3px 0; ">
		<span style="color:red; margin-left:10px;">温馨提示：</span>请您输入系统名称进行查找，选择您需要的名称，谢谢！
	</div>
	...
	<form id="pageForm" name="form"   method="post">
	 <table class="gl_table_a01" border="0" cellspacing="0" width="100%"
						cellpadding="0">
		 <tr>
			<th width="10%">应用系统名称:</th>
			<td width="30%"><input class="gl_text01_a" style="width: 100%"  type="text"  name="name" id="name" value="${manage.name}" /></td>
			<td align="center">
	...
	<table class="gl_table_a02" width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <th width="10%"></th>
                 <th width="30%">应用系统编码</th>
                 <th width="30%">应用系统名称</th>
                 <th width="30%">接口类型</th>
               </tr>
