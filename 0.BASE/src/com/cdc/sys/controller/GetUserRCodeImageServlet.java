...
public class GetUserRCodeImageServlet extends HttpServlet {
...
//			graphics.setFont(new Font("Arial Black", Font.ITALIC, 18));
		...
		redisSessionManager.putString(SESSION_KEY_OF_RAND_CODE, resultCode);*/
		
		System.out.println("randCode  SESSION_KEY_OF_RAND_CODE = " + resultCode);
