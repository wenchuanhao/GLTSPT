	...
	<head>
		...
		<script type="text/javascript">
			...
			function doSearchs(){
			  ...
			  form.action="<%=basePath%>sys/role/selectRoleIndex/"+roleId;
			  form.submit();
			}
			function del(v){
			   var roleId=$("#roleid").val();
                ...
                -->
						...
						<div>
							<table class="gl_table_a02" width="100%" border="0"
								...
								<tr>
									<th>
										<input type="checkbox" onclick="selectAll()" name="checkAll" />
									</th>
									<th>
										角色名称
									</th>
								...
								<c:forEach items="${roles}" var="org" varStatus="i">
									<tr>
										<td>
											<input type="checkbox" value="${org.roleId}"
												name="itemOffset" />
										</td>
										<td>
											${org.roleName}
										...
										<td>
											<span class="gl_tab_tr_l"><img
												...
												onclick="addRoles('${org.roleId}')">添加</a> </span>
										</td>
									</tr>
								</c:forEach>
							</table>
