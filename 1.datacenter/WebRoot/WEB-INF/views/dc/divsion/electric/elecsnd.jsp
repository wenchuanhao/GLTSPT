...
$(function(){
 	//中
 	$("#chart_super_div").append(setContainerDiv('col-2','row-1','chart_col02','list_wrap02',year+'年'+name+'每月总用电量统计表',"${year}",'container01_04'));
	//中
 	$("#chart_super_div").append(setContainerDiv('col-2','row-1','chart_col02','list_wrap02',year+'年'+name+'各系统用电比例图',"${year}",'container01_01'));
 	//小
 	$("#chart_super_div").append(setContainerDiv('col-1','row-1','chart_col01','list_wrap01',year+'年'+name+'每月总用电量同比/环比分析表',"${year}",'container01_02'));
 	
 	
 	initContainerForPie('#container01_01','sndlevel0101',month,year);//部门维度
	//趋势
	initContainerForTimeColumn('column|line','#container01_04','用电量(度)','度','sndlevel0104',month,year);
	//同比、环比
	initContainerForTimeColumn('spline','#container01_02','用电量(度)','%','sndlevel0102',month,year);
