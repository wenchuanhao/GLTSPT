...
<form action=""  method="post"  id="form1">
	<table width="99%" border="0" cellspacing="0" cellpadding="0" class="editTable reeditTable" align="center" id="table01">
		...
		<input type="hidden" name="worksType" id="worksType" value="7"/>
		<tr>
			<td colspan="4">
...
$.ajax({
	url:"<%=basePath%>command/queryByOrgNameC",
	type:"post",
	data:{orgName : name},
...
function ev_required_item(){
		...
		if(bindChange("#contractName",200,"合同名称不得超过200个字")){
			return false;
		}
		...
		if(bindChange("#workContent",90,"工作内容不得超过90个字")){
			return false;
		}
