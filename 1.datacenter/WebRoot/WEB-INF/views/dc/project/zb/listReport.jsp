...
<div class="gl_import_m">
	...
	<tr>
		<th width="9%" align="right">项目编号：</th>
  		<td width="30%">
	    	<input id="column02" name="column02" value="${zb.column02 }" onfocus="autoCompletesColumn02()"  type="text"  placeholder="请填写项目编号" class="text01" style="width:195px;"  />
		</td> 
		<th width="9%" align="right">项目名称：</th>
	    <td width="30%">
	    	<input id="projectName" name="projectName" value="${zb.projectName}"  onfocus="autoCompletesProjectName()"  type="text"  placeholder="请填写项目名称" class="text01" style="width:195px;"  />
		</td> 
	</tr>
...
//提交查询
function ev_search(){
	document.forms[0].action="<%=basePath%>zbReport/list";
