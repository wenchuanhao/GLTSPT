...
<div class="gl_import_m">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" class="editTable reeditTable" align="center" id="table01">
	    ...
	    <tr>
		    ...
		    <td>
		    	<input name="column09"  id="column09"  type="text" class="text01" style="width:100px;" placeholder="请填写子项目管理员"  onfocus="autoCompletes(this);" onblur="this.value=''"/>
		    ...
		    <td>
		    	<input name="column05"  id="column05"  type="text" class="text01" style="width:100px;" placeholder="请填写子项目审核人"  onfocus="autoCompletes(this);" onblur="this.value=''"/>
...
function ev_list(){
window.location.href='<%=basePath%>tzbm/zxmList?id=${tzbmId}';
}
...
function ev_save(){
	if(ev_required_item()){	
		$("#form1").attr("action","<%=basePath%>zxm/saveOrUpdate1");
		$("#form1").submit();
	}
}
