...
<body>
	...
	<div class="taskCreatBox">
            ...
            <table cellpadding="0" cellspacing="5" id="table01" class="taskCreate" width="100%">
	            ...
	            <tr>
	               <th width="15%" align="right" style="color:#595959;"><em>*</em>退回原因：</th>
...
function checkSubmit(){
	...
	if( jQuery.trim(jQuery("#handelOpinion").val())=="" ){
		animateAlert("table01","handelOpinion", "退回原因不能为空" );
		return false;
	}
	if( $("#handelOpinion").val().length > 200 ){
		animateAlert("table01","handelOpinion","退回原因不得超过200个字" );
		return false;
	}
	return true;
}
...
function ev_submit(){
	...
	$("#form1").ajaxSubmit({
       	url:"<%=basePath%>rulesController/returnRemain",
    	dataType:'json',
        async:true,
        type:'POST',
