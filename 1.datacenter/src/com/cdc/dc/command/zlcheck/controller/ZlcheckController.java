package com.cdc.dc.command.zlcheck.controller;
...
public class ZlcheckController extends CommonController{

	@Autowired
	private ICommandService commandService;
	@Autowired
	private IZlcheckService zlcheckService;
	/**
     * 新增一个表单
     */
    @RequestMapping(value = "zlcheckAdd", method = {RequestMethod.GET,RequestMethod.POST})
...
//    	request.setAttribute("fileTempId", cw.getWorksId());
    	...
    	request.setAttribute("vo", cw);
    	request.setAttribute("fileTempId", cw.getWorksId());
    	return "/dc/command/zlcheck/zlcheckAdd";
    }
    /**
     * 根据合同名称查询项目名称
     */
    @RequestMapping(value = "queryByOrgNameB", method = {RequestMethod.GET,RequestMethod.POST})
    public void queryByOrgNameB(HttpServletRequest request,HttpServletResponse response) throws Exception{
     ...
     * 详情
     */
    @RequestMapping(value = "zlcheckAddQuery", method = {RequestMethod.GET,RequestMethod.POST})
    public String zlcheckAddQuery(HttpServletRequest request,HttpServletResponse response) throws Exception{
    	String id = request.getParameter("id");
    	CommandQks cw = null;
    	if (id != null && !id.equals("")) {
    		cw = (CommandQks) commandService.getEntity(CommandQks.class, id);
    	...
    	return "/dc/command/zlcheck/zlcheckQuery";
    }
    /**
     * 保存或者修改
     */
    @RequestMapping(value = "zlcheckSave", method = {RequestMethod.GET,RequestMethod.POST})
    @ResponseBody
    public void zlcheckSave(HttpServletRequest request, HttpServletResponse response,CommandQks cw){
    	//保存失败
    	String result = "0";
        	try{
     ...
     * 打印
     */
    @RequestMapping(value = "zlcheckAddView", method = {RequestMethod.GET,RequestMethod.POST})
    public String zlcheckAddView(HttpServletRequest request,HttpServletResponse response) throws Exception{
    	String id = request.getParameter("id");
    	CommandQks cw = null;
    	if (id != null && !id.equals("")) {
    		cw = (CommandQks) commandService.getEntity(CommandQks.class, id);
    	...
    	return "/dc/command/zlcheck/zlcheckView";
    }
}
