package com.cdc.inter.client.db.sqlserver.jdbc;
...
public class SqlJdbcConnection {
    ...
    public static Connection getConnection(String type) {
        ...
        try {
        	SqlPropertiesConfig sConfig = new SqlPropertiesConfig("jdbc/sqlserver.properties");
	...
	public static void main(String[] args) {
        ...
        try{  
        	String type = "qianlima.ms";//仓库管理系统编码
        	
            conn = SqlJdbcConnection.getConnection(type);  
