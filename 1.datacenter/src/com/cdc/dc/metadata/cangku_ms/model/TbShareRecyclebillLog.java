...
public class TbShareRecyclebillLog implements java.io.Serializable {
	...
	private String recyclebillcode;
	...
	/** default constructor */
	public TbShareRecyclebillLog() {
	}

	/** minimal constructor */
	public TbShareRecyclebillLog(Integer billitype) {
		this.billitype = billitype;
	}

	/** full constructor */
	public TbShareRecyclebillLog(Integer billitype, Date createtime,
			String recyclebillcode, Integer catagoryid, String catagoryname,
		...
		this.recyclebillcode = recyclebillcode;
	...
	public String getRecyclebillcode() {
		return this.recyclebillcode;
	}

	public void setRecyclebillcode(String recyclebillcode) {
		this.recyclebillcode = recyclebillcode;
	}
